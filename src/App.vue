...
import zhCN from '@arco-design/web-vue/es/locale/lang/zh-cn';
    ...
    const changeThemeMode=()=>{
      ...
      if(theme.value === "dark"){
        ...
        document.getElementById("fullScreenMode").style.backgroundColor='white';
...
<template>
   <div class="layout-demo" >
    <a-layout  style="height:100%;">
      <a-layout-header class="header" >
        ...
        <a-space style="width:100%;flex-direction: row-reverse;margin-top:5px;">
           ...
           <a-button id="fullScreenMode"
            ...
            <a-button id="backgroundMode" @click="changeThemeMode" >
              <template #icon>
      ...
      <a-layout-content class="bodyContent">
        <a-space>
